...
export const aboutData = {
  img: 'profileXL1.jpg',
  paragraphOne:
    'My first foray into full stack development occured while I was trapped in Wuhan.. during the first Covid-19 Outbreak. Urged to evacuate by authorities, I chose to stay in Wuhan with my family and dogs. During which, I built ESL MiniGames, a suite of educational, engaging and highly interactive JS games that my students loved. Currently, I work at a dynamic SaaS company that helps Employees retain workforce training through AI, cognitive science techniques and gamification. I love my work!',
  paragraphTwo:
